...
var apiRoutes = []Route{
	...
	{Method: http.MethodGet, Path: "/api/auth/gitlab", Handler: GitLabLoginHandler, Description: "GitLab login", Auth: false, SessionAuth: false},
	{Method: http.MethodGet, Path: "/api/auth/gitlab/callback", Handler: GitLabCallbackHandler, Description: "GitLab OAuth callback", Auth: false, SessionAuth: false},
	{Method: http.MethodGet, Path: "/api/auth/linkedin", Handler: LinkedInLoginHandler, Description: "LinkedIn login", Auth: false, SessionAuth: false},
	{Method: http.MethodGet, Path: "/api/auth/linkedin/callback", Handler: LinkedInCallbackHandler, Description: "LinkedIn OAuth callback", Auth: false, SessionAuth: false},
